...
contract RisqStaking is BEP20, IRisqStaking {
    ...
    uint public constant LOT_PRICE = 5_000e18;
...
// File: contracts/Staking/RisqStakingBUSD.sol
...
contract RisqStakingBUSD is RisqStaking, IRisqStakingBEP20 {
    using SafeBEP20 for IBEP20;
    using SafeMath for uint;

    IBEP20 public immutable BUSD;

    constructor(BEP20 _token, BEP20 busd) public
        RisqStaking(_token, "RISQ BUSD Staking lot", "rBUSD") {
        BUSD = busd;
    }
    ...
    function sendProfit(uint amount) external override {
        ...
        if (_totalSupply > 0) {
            ...
            BUSD.safeTransferFrom(msg.sender, FALLBACK_RECIPIENT, amount);
        }
    }
